...
class BeardCatalog extends StatefulWidget {
  const BeardCatalog({Key? key}) : super(key: key);

  @override
  _BeardCatalogState createState() => _BeardCatalogState();
}

class _BeardCatalogState extends State<BeardCatalog> {
        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              topTitle(context,"Beard Style Catalog"),
              SizedBox(
                height: 10,
              ),
              Container(
